[finalproject-2b5c] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [finalproject-2b5c] container is NOT running**.

.. tip::
   You must have your [finalproject-2b5c] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45519  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='vanesalcb06'  \-\-env DOCKERUSERNAME='vanesalcb'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   vanesalcb/finalproject-2b5c-amd64 (https://hub.docker.com/r/vanesalcb/finalproject-2b5c-amd64)
...
.. code-block::
   ...
   docker run -d -p 41347:41347 -p 44431:44431 -p 42755:42755 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=finalproject-2b5c \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalproject-2b5c \
          --env GITUSERNAME=vanesalcb06 \
          --env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=41347 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=44431  \
          --env SOLUTIONVIPERVIZPORT=42755 \
          ...
          vanesalcb/finalproject-2b5c-amd64
...
[finalproject-2b5c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/vanesalcb06/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/finalproject-2b5c
...
.. important::
   https://finalproject-2b5c.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-finalproject-2b5c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=41347, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44973, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42215, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39153, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45867, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35993, HPDEHOST=127.0.1.1, HPDEPORT=45461, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36887

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3018-finalproject-2b5c,solution_preprocessing_ai_mqtt_dag-finalproject-2b5c, python-preprocess-6006-finalproject-2b5c,solution_preprocessing_ai_mqtt_dag-finalproject-2b5c, python-ai-8191-finalproject-2b5c,solution_preprocessing_ai_mqtt_dag-finalproject-2b5c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
